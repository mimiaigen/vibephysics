...
def nunchucks_1_node_group(node_tree_names: dict[typing.Callable, str]):
    """Initialize Nunchucks node group"""
    nunchucks_1 = bpy.data.node_groups.new(type='GeometryNodeTree', name="Nunchucks")

    nunchucks_1.color_tag = 'NONE'
    nunchucks_1.description = ""
    nunchucks_1.default_group_node_width = 606
    nunchucks_1.is_modifier = True
    nunchucks_1.show_modifier_manage_panel = True

    # nunchucks_1 interface

    # Socket geoi
    geoi_socket = nunchucks_1.interface.new_socket(name="geoi", in_out='OUTPUT', socket_type='NodeSocketGeometry')
    geoi_socket.attribute_domain = 'POINT'
    geoi_socket.default_input = 'VALUE'
    geoi_socket.structure_type = 'AUTO'

    # Socket geo
    geo_socket = nunchucks_1.interface.new_socket(name="geo", in_out='INPUT', socket_type='NodeSocketGeometry')
    geo_socket.attribute_domain = 'POINT'
    geo_socket.default_input = 'VALUE'
    geo_socket.structure_type = 'AUTO'

    # Initialize nunchucks_1 nodes

    # Node 组输出
    ___ = nunchucks_1.nodes.new("NodeGroupOutput")
    ___.name = "组输出"
    ___.is_active_output = True

    # Node 群组.002
    ___002 = nunchucks_1.nodes.new("GeometryNodeGroup")
    ___002.name = "群组.002"
    ___002.node_tree = bpy.data.node_groups[node_tree_names[ugrs_mainnodetree_v1_0_1_node_group]]
    # Socket_68
    ___002.inputs[0].default_value = 'On'
    # Socket_41
    ___002.inputs[1].default_value = False
    # Socket_45
    ___002.inputs[2].default_value = True
    if "objClipCenter" in bpy.data.objects:
        ___002.inputs[3].default_value = bpy.data.objects["objClipCenter"]
    # Socket_11
    ___002.inputs[4].default_value = 'multi-4dgs'
    if "NunchucksPro" in bpy.data.objects:
        ___002.inputs[6].default_value = bpy.data.objects["NunchucksPro"]
    if "4DAsset1" in bpy.data.collections:
        ___002.inputs[7].default_value = bpy.data.collections["4DAsset1"]
    # Socket_27
    ___002.inputs[8].default_value = 235.0
    # Socket_3
    ___002.inputs[9].default_value = 60.0
    # Socket_9
    ___002.inputs[10].default_value = 1.0
    # Socket_38
    ___002.inputs[11].default_value = False
    # Socket_36
    ___002.inputs[12].default_value = 'SH'
    # Socket_31
    ___002.inputs[13].default_value = 3
    # Socket_5
    ___002.inputs[14].default_value = 'Frame Index'
    # Socket_29
    ___002.inputs[15].default_value = 1
    # Socket_40
    ___002.inputs[16].default_value = 0
    # Socket_70
    ___002.inputs[17].default_value = 'On'
    # Socket_69
    ___002.inputs[18].default_value = 60.0
    # Socket_35
    ___002.inputs[20].default_value = 2.5
    # Socket_13
    ___002.inputs[21].default_value = 'PointCloud'
    # Socket_64
    ___002.inputs[22].default_value = '3DGS'
    # Socket_60
    ___002.inputs[23].default_value = 'DualIcoSphere'
    # Socket_65
    ___002.inputs[24].default_value = 6
    # Socket_24
    ___002.inputs[25].default_value = 'Opacity & Marginal'
    # Socket_14
    ___002.inputs[26].default_value = 0.05000000074505806
    # Socket_34
    ___002.inputs[27].default_value = 'Max'
    # Socket_23
    ___002.inputs[28].default_value = True
    # Socket_16
    ___002.inputs[29].default_value = 100.0
    # Socket_17
    ___002.inputs[30].default_value = 0.0
    # Socket_15
    ___002.inputs[31].default_value = 2.0
    # Socket_37
    ___002.inputs[32].default_value = 'Gaussion'
    # Socket_61
    ___002.inputs[33].default_value = True
    # Socket_18
    ___002.inputs[34].default_value = 'Final color'
    # Socket_66
    ___002.inputs[35].default_value = 0
    # Socket_67
    ___002.inputs[36].default_value = 3
    # Socket_72
    ___002.inputs[37].default_value = 'NDC'
    # Socket_20
    ___002.inputs[38].default_value = False
    # Socket_19
    ___002.inputs[39].default_value = False

    # Node 值
    _ = nunchucks_1.nodes.new("ShaderNodeValue")
    _.name = "值"

    _.outputs[0].default_value = 23.631046295166016
    # Set locations
    nunchucks_1.nodes["组输出"].location = (480.0, 40.0)
    nunchucks_1.nodes["群组.002"].location = (-160.0, 40.0)
    nunchucks_1.nodes["值"].location = (-340.0, -80.0)

    # Set dimensions
    nunchucks_1.nodes["组输出"].width  = 140.0
    nunchucks_1.nodes["组输出"].height = 100.0

    nunchucks_1.nodes["群组.002"].width  = 600.0
    nunchucks_1.nodes["群组.002"].height = 100.0

    nunchucks_1.nodes["值"].width  = 140.0
    nunchucks_1.nodes["值"].height = 100.0


    # Initialize nunchucks_1 links

    # ___002.Geometry -> ___.geoi
    nunchucks_1.links.new(
        nunchucks_1.nodes["群组.002"].outputs[0],
        nunchucks_1.nodes["组输出"].inputs[0]
    )
    # _.Value -> ___002.Frame_Index_input
    nunchucks_1.links.new(
        nunchucks_1.nodes["值"].outputs[0],
        nunchucks_1.nodes["群组.002"].inputs[19]
    )
...
if __name__ == "__main__":
    ...
    nunchucks = nunchucks_1_node_group(node_tree_names)
    node_tree_names[nunchucks_1_node_group] = nunchucks.name
